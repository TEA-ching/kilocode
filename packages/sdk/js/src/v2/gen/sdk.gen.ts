...
import type {
  ...
  KeypoolliveEmbeddingModelsErrors,
  KeypoolliveEmbeddingModelsResponses,
...
export class Keypoollive extends HeyApiClient {
  ...
  /**
   * List KeypoolLive embedding models
   *
   * Vault models with usage: "embedding", for the codebase-indexing provider picker.
   */
  public embeddingModels<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
    },
